...
const faqItems: FaqItem[] = [
  {
    ...
    answer: "観戦記録（観戦済み）を7件まで保存できます。メモや費用の記録、基本の集計機能もお試しいただけます。観戦予定は上限に含みません。",
  },
  {
    category: "料金・プラン",
  ...
  },
  {
    ...
    answer: "Googleでログインできない場合は、以下をお試しください：(1) ブラウザのCookieをクリアする (2) シークレットモードで試す (3) 別のブラウザで試す。それでも解決しない場合はサポートまでご連絡ください。※Appleログインは準備中です。",
  },
  {
    category: "データ・アカウント",
  ...
  },
  {
    ...
    answer: "Freeプランで7件に達すると、新しい試合を「観戦済み」として保存できなくなります。Plus/Proプランにアップグレードすると制限が解除されます。",
  },
  {
    category: "不具合・その他",
