...
const faqItems: FaqItem[] = [
  {
    ...
    answer: "観戦記録（観戦済み）を7件まで保存できます。メモや費用の記録、基本の集計機能（過去365日分）もお試しいただけます。観戦予定は上限に含みません。",
  },
  {
    category: "料金・プラン",
  ...
  },
  {
    ...
    answer: "Freeプランで7件に達すると、新しい試合を「観戦済み」として保存できなくなります。既存の記録を削除するか、Plus/Proプランにアップグレードすると制限が解除されます。",
  },
  {
    category: "不具合・その他",
